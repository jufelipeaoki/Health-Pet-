...
<header class="header">
  ...
  <a href="logout.php"><span class="home">|Sair</span></a>
    ...
    <div class="pet1">
        <form method="POST">
     <button class="consulte" style="height:50px; width:70px; margin-right:10px;" name="consulte"><a  style="color:White" href="editar_pet.php"><?php echo($nome) ?></a></button> 
     <button class="consulte" style="height:50px; width:70px; margin-right:10px" name="consulte"><a  style="color:White" href="editarpet2.php"><?php echo($nome2) ?></a></button> 
     <button class="consulte" style="height:50px; width:70px; margin-right:10px" name="consulte"><a  style="color:White" href="editar_pet3.php"><?php echo($nome3) ?></a></button>  
     <button class="consulte" style="height:50px; width:70px; margin-right:10px" name="consulte"><a  style="color:White" href="editar_pet4.php"><?php echo($nome4) ?></a></button>  <br><br><br>
       <!-- <ul>
            ...
            <span>As caixas em branco, são para abrigar novos pets, cadastre um novo amigo!</span>
        </form>
    </div>
