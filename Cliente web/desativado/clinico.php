...
<p>Marque consultas e vacinas para o seu melhor amigo.</p>
    ...
    <hr class="hr-menor"><br>   
        ...
        <form method="post" action="escolher-pet">
              ...
              <!--Atendimento ex: clinico geral -->
              <label class="checkbox-container" for="opcao3">clinico geral
                <input type="checkbox" id="opcao3" name="clinico">
                <span class="checkmark"></span>
              </label>
              <br><br>

         <article>
            <a href="consultas-vacinas.php" class="button">Voltar <span class="flecha"><img height="16px" width="16px" src="img/circulo-de-flecha-voltar.png" alt=""></span></a>
            <br><br>
            <a href="uniade.php" class="button">Continuar <span class="flecha"><img height="20px" width="20px" src="img/circulo-de-flecha.png" alt=""></span></a>
