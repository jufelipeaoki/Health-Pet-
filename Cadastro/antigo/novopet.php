    ...
    <section>
        ...
        <div class="login-box">
            <form action="cadastroPet.php" method="POST">
              <a href="../../Tela usuario Juan/area do usuario/area2.0.php"> <h1 >Health-Pet</h1></a> 
                ...
                <span style="font-size: 15px; color:bisque; font-weight:bold">O numero do Pet é para casos de mais de um cadastro.</span><br><br>
                <div class="input-box">
                    <span class="icon"><i class="fa-regular fa-file fa-lg"></i></span>
                    <input type="text" name="numero">
                    <label>Digite o número do seu pet:   </label><br>
                </div>
